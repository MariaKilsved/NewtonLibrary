...
namespace NewtonLibraryManager.Pages
{
    public class ProfileModel : PageModel
    {
        ...
        public void OnGet(string id)
        {
            ...
            EditedUser = new Models.User { Id = User1.Id, EMail = User1.EMail, FirstName = User1.FirstName, 
                LastName = User1.LastName, IsAdmin = User1.IsAdmin, Password = User1.Password };
        }
